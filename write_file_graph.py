#!/usr/bin/env python3
"""
Script pour écrire un fichier dans SharePoint avec l'API Microsoft Graph
"""
import os
import sys
...
def write_file_graph():
    """Écrit un fichier de test dans SharePoint avec Microsoft Graph"""
    print("📝 Écriture d'un fichier dans SharePoint avec Microsoft Graph")
    print("=" * 65)
    ...
    try:
        ...
        file_content = f"""Test d'écriture SharePoint - Microsoft Graph
=========================================
...
avec l'API Microsoft Graph et l'identité personnelle.
...
"""
        ...
        # Nom du fichier
        filename = f"test-graph-api-{datetime.now().strftime('%Y%m%d-%H%M%S')}.txt"
        print(f"\n📝 Création du fichier: {filename}")
        
        # Récupération du drive principal du site
        ...
        if drive_response.status_code == 200:
            ...
            # Upload du fichier dans la racine
            ...
            if upload_response.status_code in [200, 201]:
                ...
                print("✅ Fichier créé avec succès dans la racine !")
